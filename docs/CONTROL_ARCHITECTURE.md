...
| LowSpeedCompensator | Supplies a 0.004–0.018 Nm feed-forward/breakaway ramp, adds bounded positive-speed-error assist and a low-speed hold term, and holds worsening I. | It may use the extended ceiling below 0.5 turn/s, returns to the nominal 0.014 Nm ceiling by 1.0 turn/s, is full below 1.0 turn/s, and fades to zero by 2.0 turn/s. Recovery requires both forward encoder progress and 12 ms at ≥55% of the commanded speed, so low-speed count dither cannot unload the torque prematurely. |
