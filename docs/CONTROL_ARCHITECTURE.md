...
| LowSpeedCompensator | Supplies a 0.0025–0.010 Nm feed-forward/breakaway ramp while holding worsening I. | It is full below 1.0 turn/s, fades to zero by 1.5 turn/s, and is not stacked on the normal 2 turn/s loop. Isolated encoder edges do not reset the stall timer. |
