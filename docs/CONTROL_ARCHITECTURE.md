...
| LowSpeedCompensator | Supplies a 0.004–0.014 Nm feed-forward/breakaway ramp, adds bounded positive-speed-error assist and a low-speed hold term, and holds worsening I. | It is full below 1.0 turn/s, fades to zero by 2.0 turn/s, and is not stacked on the normal high-speed loop. Recovery requires both forward encoder progress and 12 ms at ≥55% of the commanded speed, so low-speed count dither cannot unload the torque prematurely. |
