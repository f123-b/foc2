...
public:
    ...
    // current_state_ changes before the selected control-loop handler has
    // finished initializing. Protocol-side calibration must wait for this
    // flag instead of treating AXIS_STATE_CLOSED_LOOP_CONTROL as sufficient.
    volatile bool closed_loop_control_active_ = false;
    Homing_t homing_;
