...
0.004～0.018 Nm 的平滑斜坡，并按正向速度误差提供限幅助推和低速保持项；0.5 turn/s 以下允许使用扩展上限，1.0 turn/s 以上恢复 0.014 Nm 的名义上限。只有编码器累计前进且实测速度持续达到目标的 55% 后才退出脱困，避免低速越齿后过早卸载。补偿在 1.0～2.0 turn/s 之间逐步退出；ABZ 积分转矩在
